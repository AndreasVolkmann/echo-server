 ...
 * @author av
 */
public class NewApplication extends javax.swing.JFrame implements java.util.Observer {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                client = new EchoClient(9090, "wildfly-x.cloudapp.net");
